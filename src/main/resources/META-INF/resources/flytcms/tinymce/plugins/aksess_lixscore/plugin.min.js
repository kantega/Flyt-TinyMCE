...
tinymce.PluginManager.add('aksess_lixscore', function(editor, url){
    ...
    editor.addButton('aksess_lixscore', {
        tooltip: 'Calculate LixScore',
        image: url + '/img/lixscore.png',
        onclick: makeLixScorePopupWindow
    });

    // Adds a new item to the insert menu
    editor.addMenuItem('aksess_lixscore', {
        text: 'Calculate LixScore',
        image: url + '/img/lixscore.png',
        context: 'tools',
        onclick: makeLixScorePopupWindow
    });
