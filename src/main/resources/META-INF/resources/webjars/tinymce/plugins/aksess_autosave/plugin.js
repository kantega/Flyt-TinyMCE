...
tinymce.PluginManager.add('aksess_autosave', function(editor) {
    ...
    editor.addButton('aksess_restoredraft', {
    ...
    editor.addMenuItem('aksess_restoredraft', {
